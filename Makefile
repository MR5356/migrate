...
DATABASE ?= postgres mysql redshift cassandra spanner cockroachdb yugabytedb clickhouse mongodb sqlserver firebird neo4j pgx pgx5 rqlite sqlite sqlite3
DATABASE_TEST ?= $(DATABASE) sqlcipher
